...
//        boolean result = sut.wordBreak(s, wordDict);
        boolean result = sut.wordBreak2(s, wordDict);
...
//        boolean result = sut.wordBreak(s, wordDict);
    ...
    @Test
    void case4() {
        String s = "applegapple";
        List<String> wordDict = List.of("apple", "leg", "app");
        sut = new WordBreaker();
...
//        boolean result = sut.wordBreak(s, wordDict);
    ...
    void case5() {
        String s = "aaaaaaa";
        List<String> wordDict = List.of("aaaa", "aa");
        sut = new WordBreaker();
...
//        boolean result = sut.wordBreak(s, wordDict);
    ...
    void case6() {
        ...
        List<String> wordDict = List.of("a", "aa", "aaa", "aaaa", "aaaaa", "aaaaaa", "aaaaaaa",
...
//        boolean result = sut.wordBreak(s, wordDict);
    ...
    void case8() {
        ...
        List<String> wordDict = List.of("kfomka", "hecagbngambii", "anobmnikj", "c",
            ...
            "gbmjfdooeeko", "jafogijka", "ngnfggojmhclkjd", "bfagnfclg", "imkeobcdidiifbm", "ogeo",
            "gicjog", "cjnibenelm", "ogoloc", "edciifkaff", "kbeeg", "nebn", "jdd", "aeojhclmdn",
            "dilbhl", "dkk", "bgmck", "ohgkefkadonafg", "labem", "fheoglj", "gkcanacfjfhogjc",
            "eglkcddd", "lelelihakeh", "hhjijfiodfi", "enehbibnhfjd", "gkm", "ggj", "ag", "hhhjogk",
            "lllicdhihn", "goakjjnk", "lhbn", "fhheedadamlnedh", "bin", "cl", "ggjljjjf",
            "fdcdaobhlhgj", "nijlf", "i", "gaemagobjfc", "dg", "g", "jhlelodgeekj", "hcimohlni",
            "fdoiohikhacgb", "k", "doiaigclm", "bdfaoncbhfkdbjd", "f", "jaikbciac", "cjgadmfoodmba",
            "molokllh", "gfkngeebnggo", "lahd", "n", "ehfngoc", "lejfcee", "kofhmoh", "cgda", "de",
            "kljnicikjeh", "edomdbibhif", "jehdkgmmofihdi", "hifcjkloebel", "gcghgbemjege",
            "kobhhefbbb", "aaikgaolhllhlm", "akg", "kmmikgkhnn", "dnamfhaf", "mjhj", "ifadcgmgjaa",
